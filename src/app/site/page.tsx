...
const SitePage = () => {
  return (
    <>
      <section className="relative flex h-full w-full flex-col items-center justify-center md:mt-[70px] md:pt-44">
        ...
        <p className="mt-[100px] text-center">Run your agency, in one place</p>
      ...
      <section className="mt-[-60px] flex flex-col items-center justify-center gap-4 pb-20 md:mt-96">
